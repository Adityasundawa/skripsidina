...
<center>
    <p class="text-white">(Badan Penyelidik Usaha-Usaha
        Kemerdekaan Indonesia)</p>
</center>
<div class="container">
    <div class="col-12">
        <div class="card custom-card"
            style="background-color: #fff5dc; border: 7px solid #b2783f; width: auto; height: 690px;">
            <div class="card-body">
                        ...
                        <div class="row d-flex">
                            <div class="col-lg-4 col-8">
                                <p class="text-pahlawan">
                                   <strong> Dasar negara yang diusulkan Muh. Yamin (29 Mei 1945): </strong><br>
                                    1) Peri Kebangsaan <br>
                                    2) Peri Kemanusiaan <br>
                                    3) Peri Ketuhanan <br>
                                    4) Peri Kerakyatan <br>
                                    5) Kesejahteraan rakyat <br>
                                </p>
                            </div>
                            ...
                            <div class="col-lg-4 col-8">
                                <p class="text-pahlawan">
                                    ...
                                    2) Peri Kemanusiaan (Internasionalisme) <br>
